...
const Feed = () => {
  ...
  return (
    <div
      className={`flex flex-col ${themeClass.bg} w-full h-screen overflow-hidden`}
    >
      {linear && <LinearLoader />}
      <NavBar />
      <div className="flex">
        ...
        >
            ...
            <div className="absolute px-3 text-white justify-center top-0 left-0 w-full flex flex-col bg-black/50 h-full">
              ...
              <div className="flex xs:text-xl flex-wrap">
                <p className=" mt-2 font-semibold">
                  uefa champions league draw to be confirmed
                </p>
              </div>
              <Link href={`/login`} className="">
                <button
                  className={`py-1 flex mt-3 w-[150px] items-center justify-center duration-300
          ...
          <div className="flex flex-col">
            ...
            <div className={`flex flex-col ${themeClass.bg} rounded-lg`}>
              <div
                className={`grid ltab:grid-cols-2 xtab:grid-cols-3 pb-3 phone:px-3 pt-0`}
              >
