        ...
        <div className="flex">
            ...
            <div onClick={()=> setMobile(false)} className={`flex ${themeClass.bgAlt} ${themeClass.text} flex-col px-3 w-full h-[92vh] overflow-y-auto`}>
              <div className={`flex flex-col items-center min-h[92vh]  p-2 w-full ${themeClass.bg}`}>
                ...
                <div className='flex w-full relative z-10 items-center justify-center mt-3'>
                  <div className='absolute top-0 left-0 h-full z-0 w-full border-b-2'></div>
                  <div className="flex items-center z-10 bg-white">
                    <div onClick={()=>handleLeagueTypeChange('League')}
                      className={`flex ${leagueType==='League'?'border-x-2 border-t-2 border-b-2 border-b-white':'border-b-2 border-t-2 border-t-white'}
                    ...
                    <div onClick={()=>handleLeagueTypeChange('Cup')}
                      className={`flex ${leagueType==='Cup'?'border-x-2 border-t-2 border-b-2 border-b-white':'border-b-2 border-t-2 border-t-white'}
                       cursor-pointer py-2 px-3 items-center`}>
